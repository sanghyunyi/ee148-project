...
class affordance_model(nn.Module):
    def __init__(self, originalModel):
        ...
        self.pinch = nn.Linear(129, 10)
        self.clench = nn.Linear(129, 10)
        self.poke = nn.Linear(129, 10)
        self.palm = nn.Linear(129, 10)
            ...
            for phase in ['train', 'val']:
                ...
                # deep copy the model
                    ...
                    if epoch_loss < best_loss:
                        ...
                        torch.save(model, os.path.join(ckpt_dir, 'vgg11_size_{}_fold_best.ckpt'.format(n)))
                        best_model_wts = copy.deepcopy(model.state_dict())
                        test_model(model)
                        no_update_count = 0
